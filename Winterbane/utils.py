...
async def auto_buy_potions(client):
    ...
    await client.wait_for_zone_change()
    # winterbane Extra Code
    await client.goto(-13.27971363067627, 2790.166015625)
    await client.wait_for_zone_change()
    await client.goto(3050.296630859375, 17.513824462890625)
    await client.wait_for_zone_change()
...
async def decide_heal(client):
    if await client.needs_potion(health_percent=10, mana_percent=10) and not await client.has_potion():
